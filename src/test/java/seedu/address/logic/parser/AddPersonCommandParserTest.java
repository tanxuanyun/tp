...
import static seedu.address.logic.commands.PersonCommandTestUtil.INVALID_LINK_INDEX_DESC;
...
public class AddPersonCommandParserTest {
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + LINK_INDEX_DESC_AMY,
